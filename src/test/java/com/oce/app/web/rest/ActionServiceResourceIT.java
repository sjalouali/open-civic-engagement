...
public class ActionServiceResourceIT {
    ...
    public void createActionService() throws Exception {
        ...
        assertThat(testActionService.getUuidOce()).isEqualTo(DEFAULT_UUID_OCE);
        assertThat(testActionService.getUuidOrganisation()).isEqualTo(DEFAULT_UUID_ORGANISATION);
        assertThat(testActionService.getUuidEntity()).isEqualTo(DEFAULT_UUID_ENTITY);
        assertThat(testActionService.isArchived()).isEqualTo(DEFAULT_ARCHIVED);
        assertThat(testActionService.isDeleted()).isEqualTo(DEFAULT_DELETED);
    }
    ...
    @Test
    @Transactional
    public void getAllActionServicesByUuidOceIsEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOce equals to DEFAULT_UUID_OCE
        defaultActionServiceShouldBeFound("uuidOce.equals=" + DEFAULT_UUID_OCE);

        // Get all the actionServiceList where uuidOce equals to UPDATED_UUID_OCE
        defaultActionServiceShouldNotBeFound("uuidOce.equals=" + UPDATED_UUID_OCE);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidOceIsNotEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOce not equals to DEFAULT_UUID_OCE
        defaultActionServiceShouldNotBeFound("uuidOce.notEquals=" + DEFAULT_UUID_OCE);

        // Get all the actionServiceList where uuidOce not equals to UPDATED_UUID_OCE
        defaultActionServiceShouldBeFound("uuidOce.notEquals=" + UPDATED_UUID_OCE);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidOceIsInShouldWork() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOce in DEFAULT_UUID_OCE or UPDATED_UUID_OCE
        defaultActionServiceShouldBeFound("uuidOce.in=" + DEFAULT_UUID_OCE + "," + UPDATED_UUID_OCE);

        // Get all the actionServiceList where uuidOce equals to UPDATED_UUID_OCE
        defaultActionServiceShouldNotBeFound("uuidOce.in=" + UPDATED_UUID_OCE);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidOceIsNullOrNotNull() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOce is not null
        defaultActionServiceShouldBeFound("uuidOce.specified=true");

        // Get all the actionServiceList where uuidOce is null
        defaultActionServiceShouldNotBeFound("uuidOce.specified=false");
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidOrganisationIsEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOrganisation equals to DEFAULT_UUID_ORGANISATION
        defaultActionServiceShouldBeFound("uuidOrganisation.equals=" + DEFAULT_UUID_ORGANISATION);

        // Get all the actionServiceList where uuidOrganisation equals to UPDATED_UUID_ORGANISATION
        defaultActionServiceShouldNotBeFound("uuidOrganisation.equals=" + UPDATED_UUID_ORGANISATION);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidOrganisationIsNotEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOrganisation not equals to DEFAULT_UUID_ORGANISATION
        defaultActionServiceShouldNotBeFound("uuidOrganisation.notEquals=" + DEFAULT_UUID_ORGANISATION);

        // Get all the actionServiceList where uuidOrganisation not equals to UPDATED_UUID_ORGANISATION
        defaultActionServiceShouldBeFound("uuidOrganisation.notEquals=" + UPDATED_UUID_ORGANISATION);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidOrganisationIsInShouldWork() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOrganisation in DEFAULT_UUID_ORGANISATION or UPDATED_UUID_ORGANISATION
        defaultActionServiceShouldBeFound("uuidOrganisation.in=" + DEFAULT_UUID_ORGANISATION + "," + UPDATED_UUID_ORGANISATION);

        // Get all the actionServiceList where uuidOrganisation equals to UPDATED_UUID_ORGANISATION
        defaultActionServiceShouldNotBeFound("uuidOrganisation.in=" + UPDATED_UUID_ORGANISATION);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidOrganisationIsNullOrNotNull() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidOrganisation is not null
        defaultActionServiceShouldBeFound("uuidOrganisation.specified=true");

        // Get all the actionServiceList where uuidOrganisation is null
        defaultActionServiceShouldNotBeFound("uuidOrganisation.specified=false");
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidEntityIsEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidEntity equals to DEFAULT_UUID_ENTITY
        defaultActionServiceShouldBeFound("uuidEntity.equals=" + DEFAULT_UUID_ENTITY);

        // Get all the actionServiceList where uuidEntity equals to UPDATED_UUID_ENTITY
        defaultActionServiceShouldNotBeFound("uuidEntity.equals=" + UPDATED_UUID_ENTITY);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidEntityIsNotEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidEntity not equals to DEFAULT_UUID_ENTITY
        defaultActionServiceShouldNotBeFound("uuidEntity.notEquals=" + DEFAULT_UUID_ENTITY);

        // Get all the actionServiceList where uuidEntity not equals to UPDATED_UUID_ENTITY
        defaultActionServiceShouldBeFound("uuidEntity.notEquals=" + UPDATED_UUID_ENTITY);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidEntityIsInShouldWork() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidEntity in DEFAULT_UUID_ENTITY or UPDATED_UUID_ENTITY
        defaultActionServiceShouldBeFound("uuidEntity.in=" + DEFAULT_UUID_ENTITY + "," + UPDATED_UUID_ENTITY);

        // Get all the actionServiceList where uuidEntity equals to UPDATED_UUID_ENTITY
        defaultActionServiceShouldNotBeFound("uuidEntity.in=" + UPDATED_UUID_ENTITY);
    }

    @Test
    @Transactional
    public void getAllActionServicesByUuidEntityIsNullOrNotNull() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where uuidEntity is not null
        defaultActionServiceShouldBeFound("uuidEntity.specified=true");

        // Get all the actionServiceList where uuidEntity is null
        defaultActionServiceShouldNotBeFound("uuidEntity.specified=false");
    }

    @Test
    @Transactional
    public void getAllActionServicesByArchivedIsEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where archived equals to DEFAULT_ARCHIVED
        defaultActionServiceShouldBeFound("archived.equals=" + DEFAULT_ARCHIVED);

        // Get all the actionServiceList where archived equals to UPDATED_ARCHIVED
        defaultActionServiceShouldNotBeFound("archived.equals=" + UPDATED_ARCHIVED);
    }

    @Test
    @Transactional
    public void getAllActionServicesByArchivedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where archived not equals to DEFAULT_ARCHIVED
        defaultActionServiceShouldNotBeFound("archived.notEquals=" + DEFAULT_ARCHIVED);

        // Get all the actionServiceList where archived not equals to UPDATED_ARCHIVED
        defaultActionServiceShouldBeFound("archived.notEquals=" + UPDATED_ARCHIVED);
    }

    @Test
    @Transactional
    public void getAllActionServicesByArchivedIsInShouldWork() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where archived in DEFAULT_ARCHIVED or UPDATED_ARCHIVED
        defaultActionServiceShouldBeFound("archived.in=" + DEFAULT_ARCHIVED + "," + UPDATED_ARCHIVED);

        // Get all the actionServiceList where archived equals to UPDATED_ARCHIVED
        defaultActionServiceShouldNotBeFound("archived.in=" + UPDATED_ARCHIVED);
    }

    @Test
    @Transactional
    public void getAllActionServicesByArchivedIsNullOrNotNull() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where archived is not null
        defaultActionServiceShouldBeFound("archived.specified=true");

        // Get all the actionServiceList where archived is null
        defaultActionServiceShouldNotBeFound("archived.specified=false");
    }

    @Test
    @Transactional
    public void getAllActionServicesByDeletedIsEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where deleted equals to DEFAULT_DELETED
        defaultActionServiceShouldBeFound("deleted.equals=" + DEFAULT_DELETED);

        // Get all the actionServiceList where deleted equals to UPDATED_DELETED
        defaultActionServiceShouldNotBeFound("deleted.equals=" + UPDATED_DELETED);
    }

    @Test
    @Transactional
    public void getAllActionServicesByDeletedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where deleted not equals to DEFAULT_DELETED
        defaultActionServiceShouldNotBeFound("deleted.notEquals=" + DEFAULT_DELETED);

        // Get all the actionServiceList where deleted not equals to UPDATED_DELETED
        defaultActionServiceShouldBeFound("deleted.notEquals=" + UPDATED_DELETED);
    }

    @Test
    @Transactional
    public void getAllActionServicesByDeletedIsInShouldWork() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where deleted in DEFAULT_DELETED or UPDATED_DELETED
        defaultActionServiceShouldBeFound("deleted.in=" + DEFAULT_DELETED + "," + UPDATED_DELETED);

        // Get all the actionServiceList where deleted equals to UPDATED_DELETED
        defaultActionServiceShouldNotBeFound("deleted.in=" + UPDATED_DELETED);
    }

    @Test
    @Transactional
    public void getAllActionServicesByDeletedIsNullOrNotNull() throws Exception {
        // Initialize the database
        actionServiceRepository.saveAndFlush(actionService);

        // Get all the actionServiceList where deleted is not null
        defaultActionServiceShouldBeFound("deleted.specified=true");

        // Get all the actionServiceList where deleted is null
        defaultActionServiceShouldNotBeFound("deleted.specified=false");
    }
    ...
    public void updateActionService() throws Exception {
        ...
        assertThat(testActionService.getUuidOce()).isEqualTo(UPDATED_UUID_OCE);
        assertThat(testActionService.getUuidOrganisation()).isEqualTo(UPDATED_UUID_ORGANISATION);
        assertThat(testActionService.getUuidEntity()).isEqualTo(UPDATED_UUID_ENTITY);
        assertThat(testActionService.isArchived()).isEqualTo(UPDATED_ARCHIVED);
        assertThat(testActionService.isDeleted()).isEqualTo(UPDATED_DELETED);
    }
